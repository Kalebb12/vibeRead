        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
          ...
          {audio && (
            <div className="mt-8 pt-8 border-t border-gray-200">
              ...
              <p className="text-sm text-gray-500 mt-4 text-center">
                You can adjust playback speed and control playback using the player above
              </p>
            </div>
          )}
          ...
          <div className="mt-8 pt-8 border-t border-gray-200">
            ...
            <ul className="space-y-2 text-gray-600">
              ...
              <li className="flex items-start gap-2">
                <span className="text-blue-600">•</span>
                <span>Make sure your text is well-formatted for better audio quality</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-600">•</span>
                <span>You can generate multiple audio files by submitting different texts</span>
              </li>
            </ul>
          </div>
        </div>
